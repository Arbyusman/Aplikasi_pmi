				...
				<div class="col-md-12">
					<div class="icon-box table-responsive">
						...
						<div class="form-content bk">
							<form action="<?= base_url('Donor_darah/AksiInsertDonorUser') ?>" method="POST">
								...
								<fieldset class="scheduler-border">
									...
									<div class="row">
										<div class="col-sm-4">
											<label for="no-kartu">No.Kartu Pendonor</label>
											<input type="text" class="form-control" placeholder="Masukan No.Kartu"  name="no_kartu">
										</div>
										<div class="col-sm-4">
